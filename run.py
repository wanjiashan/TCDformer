...
def main():
    ...
    parser.add_argument('--model', type=str, default='TCDformer',
                        help='model name, options: [TCDformer]')

    # supplementary config for FEDformer model
    parser.add_argument('--version', type=str, default='Wavelets',
                        help='for FEDformer, there are two versions to choose, options: [Time, Fourier, Wavelets]')
